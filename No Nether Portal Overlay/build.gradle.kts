...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        file.displayName = "[${libs.versions.minecraft.get()}] No Nether Portal Overlay"
...
modrinth {
    ...
    projectId = "no-nether-portal-overlay"
    uploadFile.set(tasks.remapJar)
    gameVersions.add(libs.versions.minecraft)
    versionName = libs.versions.minecraft.map { "[$it] No Nether Portal Overlay" }
    dependencies {
