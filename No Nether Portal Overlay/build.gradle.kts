...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        val file = upload(486338, remapJar)
        file.displayName = "[${project.extra["minecraft_version"] as String}] No Nether Portal Overlay"
...
modrinth {
    ...
    projectId.set("no-nether-portal-overlay")
    uploadFile.set(tasks.remapJar)
    gameVersions.addAll(project.extra["minecraft_version"] as String)
    versionName.set("[${project.extra["minecraft_version"] as String}] No Nether Portal Overlay")
    dependencies {
